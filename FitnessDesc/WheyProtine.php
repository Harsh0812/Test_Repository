            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "https://m.media-amazon.com/images/I/616cI2pfTOL._SL1200_.jpg" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "https://m.media-amazon.com/images/I/616cI2pfTOL._SL1200_.jpg"></div>
                        <div><img src = "https://www.bigbasket.com/media/uploads/p/l/40167201-4_4-optimum-nutrition-gold-standard-100-whey-protein-isolate-double-rich-chocolate.jpg"></div>
                        <div><img src = "https://newassets.apollo247.com/pub/media/catalog/product/i/m/img_20210108_151143__side__whey_protein_1kg.jpg"></div>
                        <div><img src = "https://onemg.gumlet.io/l_watermark_346,w_480,h_480/a_ignore,w_480,h_480,c_fit,q_auto,f_auto/wecfjoqmsampnmgold7p.jpg"></div>
                        <div><img src = "https://cdn.healthxp.in/wp-content/uploads/2017/07/ON-Optimum-Nutrition-Gold-Standard-100-Whey-Protein-2-lbs-1.jpg"></div>
                        
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Nutrition </span>
                    ...
                    <p class = "product-description">Whey protein is the protein from whey, the watery portion of milk that separates from the curds when making cheese. It is commonly used as a protein supplement.
                        </p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Benefits of Nutrition</h4>
                        
                        <li>Stronger immunity , Improved memory , Strong teeth and bones , Improved vision , Decreases anxiety</li>
                    ...
                    <h4>How to use</h4>
                    <p class="product-description">
                        Nausea, thirst, bloating, reduced appetite, tiredness, and headache
...
<div class="footer-basic">
    <footer>
        <div class="social">
            <a class="ins" href="https://www.instagram.com/accounts/login/"><i class="fab fa-instagram"></i></a>
            <a class="snap" href="https://www.snapchat.com"><i class="fab fa-snapchat"></i></a>
             <a class="twi" href="https://www.twitter.com"><i class="fab fa-twitter"></i></a>
             <a class="face" href="https://www.facebook.com"><i class="fab fa-facebook"></i></a></div>
