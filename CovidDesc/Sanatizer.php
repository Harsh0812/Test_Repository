            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "https://laz-img-sg.alicdn.com/p/5d490a51a8227269c6920284f06f98d6.jpg" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "https://laz-img-sg.alicdn.com/p/5d490a51a8227269c6920284f06f98d6.jpg"></div>
                        <div><img src = "https://lzd-img-global.slatic.net/g/p/9cd67542f79cea04cd7d1d3a6985f50e.jpg_720x720q80.jpg_.webp"></div>
                        <div><img src = "https://my-test-11.slatic.net/p/2034891ba0975172605ff1fdb850cd6f.jpg"></div>
                        <div><img src = "https://cdn.shopify.com/s/files/1/0922/1918/products/Softa-Man_Cutaneous_Solution_500ml_2_384x384.jpg?v=1581920456"></div>
                        <div><img src = "https://www.bbraun.com/content/dam/catalog/bbraun/bbraunProductCatalog/S/AEM2015/en-01/b11/softa-man-group0.jpeg.transform/75/image.jpg"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Sanitizer</span>
                    ...
                    <p class = "product-description">Apollo Pharmacy Instant Protection hand sanitizer is a supplement or alternative to hand washing with soap and water. It kills 99.9% of most common germs.
                        Allow you to clean your hand s whenever conventional soap and water is not available i.e. Instant Protection on the go.It is enriched with moisturizer and special fragrance has been added to create a delightful experience.</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Contraindications of Sanitizer</h4>
                        
                        <li> Even though the absolute contraindication of alcohol-based hand sanitizers (ABHS) is limited to severe allergic reactions (such as anaphylaxis to aliphatic alcohols), there are a few concerns about its use.</li>
                        <li>Allergic contact dermatitis can also vary from mild to severe symptoms and may sometimes be accompanied by respiratory distress.</li>  
                    ...
                    <br>
                    <h4>Side effects of Sanitizer</h4>
                    <p class="product-description">
                        Commonly reported symptoms included headache, nausea, and dizziness, likely because of vapors from the hand sanitizer product, and potentially from exposure in enclosed spaces.
