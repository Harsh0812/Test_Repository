...
<div class="A" style="display: flex; flex-direction:row9">
    <div id="header">
        <div class="row1">
            <a href="dashboard.html"><img id="logo" src="C:\Users\asus\Desktop\Mini_Project1\output-onlinepngtools.png" ></a>
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "https://n2.sdlcdn.com/imgs/h/c/v/EasyCare-EC-5004-Digital-Thermometer-SDL842983050-1-f869b.jpg" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "https://n2.sdlcdn.com/imgs/h/c/v/EasyCare-EC-5004-Digital-Thermometer-SDL842983050-1-f869b.jpg"></div>
                        <div><img src = "thermometer\topnotch-digital-thermometer-3-1654250180.webp"></div>
                        <div><img src = "thermometer\topnotch-digital-thermometer-6.1-1654250448.webp"></div>
                        <div><img src = "https://rukminim1.flixcart.com/image/416/416/kar44280/digital-thermometer/v/y/w/top-notch-digital-na-original-imafs8uqfpe2p5ax.jpeg?q=70"></div>
                        <div><img src = "https://onemg.gumlet.io/l_watermark_346,w_690,h_700/a_ignore,w_690,h_700,c_pad,q_auto,f_auto/cropped/jyvj7wpgmnlhbjsqigzq.png"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Thermometer</span>
                    ...
                    <div class = "product-rating">
                        ...
                        <span>(450 ratings)</span>
                    </div>
                    
                    <p class = "product-description">The Topnotch digital thermometer is an efficient device to measure body temperature to determine a fever. The thermometer is fast and easy to use. Just place it in your mouth, under the tongue and wait for a reading. </p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Benefits of Thermometer</h4>
                        
                        <li>  Efficient and fast when it comes to taking body temperature.</li>
                        <li>Safe to use for both adults and children as it is mercury-free.</li>  
                        <li>Dual-mode allows reading in both Celsius and Fahrenheit.</li>
                       <li>Clinically tested for high precision.</li>  
                    ...
                    <p class="product-description">
                        <span>Keep it away from the reach of children.</span>
                        <span>Store it in a cool and dry place.</span>
                       <span> Do not bite the silver nib of the thermometer.</span>
