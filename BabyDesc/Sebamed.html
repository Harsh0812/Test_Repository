            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "https://www.littleshop.in/wp-content/uploads/2021/06/Sebamed-Baby-Cream-Extra-Soft-1-1.jpg" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "https://www.littleshop.in/wp-content/uploads/2021/06/Sebamed-Baby-Cream-Extra-Soft-1-1.jpg"></div>
                        <div><img src = "https://www.jiomart.com/images/product/600x600/410101770001/sebamed-extra-soft-baby-cream-200-ml-product-images-o410101770001-p590126500-0-202203151139.jpg"></div>
                        <div><img src = "https://www.littleshop.in/wp-content/uploads/2021/06/Sebamed-Baby-Cream-Extra-Soft-3.jpg"></div>
                        <div><img src = "https://rukminim1.flixcart.com/image/416/416/k9ej53k0/combo-kit/r/n/x/baby-all-weather-skin-care-combo-pack-protective-facial-cream-original-imafr7g65mcfwwch.jpeg?q=70"></div>
                        <div><img src = "https://www.makeupandbeautyforever.com/wp-content/uploads/2019/04/Sebamed-Baby-Protective-Facial-Cream-Review-922x692.jpg"></div>
                        
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Sebamed Baby Facial Cream </span>
                    <span class = "product-price">₹ 189.50</span>
                    ...
                    <p class = "product-description">Sebamed Baby Cream is an extra soft cream for babies which comes in a 200ml bottle. The baby cream is dermatologically tested and suitable to be used for babies up to three months of age.
                        </p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Uses of Sebamed Baby Cream</h4>
                        
                        <li>Sebamed baby cream is applied to babies from the age of a month to around three or four months. </li>
                        <li>The extra-soft skin cream helps in maintaining the softness of baby skin and also protects against any environmental irritants.</li>  
                    ...
                    <p class="product-description">
                        <span>The cream should be stored in a dry, cool place away from direct sunlight.</span>
                        <span>It should be used per the instructions on the label.</span>
                        <span>The cream should be kept out of reach of small children.
                        </span> 
