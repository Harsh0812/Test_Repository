            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "https://rukminim1.flixcart.com/image/416/416/kgy0sy80/diaper/z/s/k/large-size-baby-diapers-lg-64-count-anti-rash-diapers-lotion-original-imafx2hzmuvmsbgf.jpeg?q=70" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "https://rukminim1.flixcart.com/image/416/416/kgy0sy80/diaper/z/s/k/large-size-baby-diapers-lg-64-count-anti-rash-diapers-lotion-original-imafx2hzmuvmsbgf.jpeg?q=70"></div>
                        <div><img src = "https://www.jiomart.com/images/product/600x600/491071090/pampers-all-round-protection-pants-xl-34-count-12-17-kg-product-images-o491071090-p491071090-8-202209231754.jpg"></div>
                        <div><img src = "https://www.bigbasket.com/media/uploads/p/l/40136607-7_1-pampers-diaper-pants-small.jpg"></div>
                        <div><img src = "https://www.littleshop.in/wp-content/uploads/2021/06/Pamper-Premium-Care-Pant-Style-Diapers-Small-21-2.jpg"></div>
                        <div><img src = "https://www.jiomart.com/images/product/original/490998026/pampers-new-baby-diapers-24-count-up-to-5-kg-product-images-o490998026-p590087207-7-202209231749.jpg"></div>
                        
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Pamper-pants</span>
                    <span class = "product-price">₹ 929.50</span>
                    ...
                    <p class = "product-description">The new and improved Pampers New Diaper Pants give babies a renewed feeling of dryness throughout the night. This new version of the diapers has double protection against leakage, so it is suitable to wear for up to 12 hours. The diaper has baby lotion containing aloe vera that keeps the baby's soft skin dry, rash-free and irritation-free. The flexible pant-style diapers fit the baby well, allowing him to frolic the entire day.
                        </p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Uses of Pamper-pants</h4>
                        
                        <li>The pant-style diapers are helpful for babies in their bedwetting days.</li>
                    ...
                    <p class="product-description">
                        <span>Keep the diaper away from the flame.</span>
                        <span>Dispose of the diaper after use in a garbage bin wrapped in paper.</span>
                        <span>Use the product only till the date of expiry.
                        </span>
